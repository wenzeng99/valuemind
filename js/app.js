...
let signalData = {
  zh: {
    duan: [
      { type:'green', cat:'能源', title:'伊朗袭击美油轮+WTI破$85，XOM/CVX现金流将超预期', tk:'XOM', q:'能源是刚需生意。地缘溢价短期推升，但长期看自由现金流。' },
      { type:'green', cat:'消费零售', title:'Costco会员续费率93%+，通胀环境下消费者粘性验证', tk:'COST', q:'会员制护城河如茅台。油价上涨反而推动Costco性价比优势。' },
      { type:'yellow', cat:'AI算力', title:'NVDA PE 37x面临竞争加剧，AMD/Google追赶', tk:'NVDA', q:'AI卖铲子依然最好的生意，但$183的价格需要耐心等回调。' },
      { type:'red', cat:'地缘风险', title:'美伊全面冲突升级，供应链不确定性飙升', tk:'—', q:'战争驱动不碰。投资找10年不变的东西，不赌地缘博弈。' },
    ],
    buffett: [
      { type:'green', cat:'能源', title:'WTI原油$85+，雪佛龙/埃克森现金流充沛', tk:'CVX', q:'石油在战争中更不可替代。CVX $190低于内在价值，分红稳定。' },
      { type:'green', cat:'消费零售', title:'Costco通胀环境下的定价权验证', tk:'COST', q:'消费者特许权典范。高油价时代，Costco的性价比是护城河。' },
      { type:'yellow', cat:'保险', title:'利率维持高位，BRK浮存金收益率持续提升', tk:'BRK.B', q:'Berkshire在高利率环境中如鱼得水。但$500的价格不算便宜。' },
      { type:'red', cat:'医疗', title:'UNH被Jefferies下调目标价至$340，营收首次预期下滑', tk:'UNH', q:'好公司遇到坏时机。等管理层证明能扭转趋势再说。' },
    ],
    munger: [
      { type:'green', cat:'消费零售', title:'Costco在滞胀环境中的反脆弱性', tk:'COST', q:'最爱。油价越高消费者越需要性价比，会员费=纯利润。' },
      { type:'green', cat:'AI算力', title:'NVDA PEG仍合理，AI基建支出未见拐点', tk:'NVDA', q:'反转思维：什么让AI支出停止？目前看不到。但$183不追高。' },
      { type:'yellow', cat:'加密', title:'哈萨克斯坦主权基金投$3.5亿加密，机构化加速', tk:'COIN', q:'Coinbase推股票交易是聪明的多元化。但加密波动性仍是双刃剑。' },
      { type:'red', cat:'地缘', title:'伊朗冲突推高油价，通胀再起风险', tk:'—', q:'别被恐惧或贪婪驱动。战争溢价是暂时的，别因此做永久决策。' },
    ],
  },
  en: {
    duan: [
      { type:'green', cat:'Energy', title:'Iran attacks US tanker, WTI breaks $85 — XOM/CVX cash flow to beat', tk:'XOM', q:'Energy is essential business. Geopolitical premium short-term, but focus on FCF.' },
      { type:'green', cat:'Consumer', title:'Costco 93%+ renewal rate, consumer stickiness proven in inflation', tk:'COST', q:'Membership moat like Moutai. Higher oil actually boosts Costco value prop.' },
      { type:'yellow', cat:'AI Compute', title:'NVDA PE 37x faces rising competition from AMD/Google', tk:'NVDA', q:'Still the best shovel business in AI. But $183 needs patience for pullback.' },
      { type:'red', cat:'Geopolitics', title:'US-Iran full conflict escalation, supply chain uncertainty surges', tk:'—', q:'War-driven = avoid. Find 10-year certainties, don\'t bet on geopolitics.' },
    ],
    buffett: [
      { type:'green', cat:'Energy', title:'WTI crude $85+, Chevron/Exxon cash flows robust', tk:'CVX', q:'Oil is even more essential in wartime. CVX at $190 below intrinsic value.' },
      { type:'green', cat:'Consumer', title:'Costco pricing power validated in inflationary environment', tk:'COST', q:'Consumer franchise epitome. High oil makes Costco\'s value prop the moat.' },
      { type:'yellow', cat:'Insurance', title:'Rates stay high, BRK float yield keeps improving', tk:'BRK.B', q:'Berkshire thrives in high-rate environments. But $500 isn\'t cheap.' },
      { type:'red', cat:'Healthcare', title:'UNH: Jefferies cuts PT to $340, first revenue decline in decades', tk:'UNH', q:'Good company, bad timing. Wait for management to prove the turnaround.' },
    ],
    munger: [
      { type:'green', cat:'Consumer', title:'Costco anti-fragility in stagflation environment', tk:'COST', q:'Favorite. Higher oil = more need for value. Membership fee = pure profit.' },
      { type:'green', cat:'AI Compute', title:'NVDA PEG still reasonable, AI infra spend shows no inflection', tk:'NVDA', q:'Invert: what stops AI spend? Nothing visible. But don\'t chase at $183.' },
      { type:'yellow', cat:'Crypto', title:'Kazakhstan sovereign fund allocates $350M to crypto', tk:'COIN', q:'Coinbase adding stocks is smart diversification. But crypto vol cuts both ways.' },
      { type:'red', cat:'Geopolitics', title:'Iran conflict drives oil higher, inflation re-acceleration risk', tk:'—', q:'Don\'t let fear or greed drive you. War premiums are temporary.' },
    ],
  },
};
...
function getAlphaEvents() {
  ...
  return {
    zh: [
      {
        conclusion: '美伊冲突升级：伊朗袭击科威特附近美国油轮，WTI原油突破$85/桶',
        impacts: [
          { asset: 'XOM/CVX', direction: 'up', note: '油价飙升利好能源股，高盛预测5周内达$100' },
          { asset: 'COST/消费', direction: 'down', note: '油价推高运输成本，压缩消费利润率' },
        ],
        priority: 'urgent',
        tags: ['地缘政治', '大宗商品'],
      },
      {
        conclusion: 'ECB年内加息25bps已被完全定价，美联储维持3.5-3.75%不变',
        impacts: [
          { asset: '成长股', direction: 'down', note: '全球利率预期上升，估值承压' },
          { asset: 'BRK-B', direction: 'up', note: '保险浮存金收益率提升，净息差扩大' },
        ],
        priority: 'important',
        tags: ['央行', '利率'],
      },
      {
        conclusion: 'S&P 500在地缘冲突中仍接近历史高位，市场韧性超预期',
        impacts: [
          { asset: 'NVDA/META', direction: 'up', note: 'AI主线逻辑未破，资金持续流入科技' },
          { asset: 'UNH', direction: 'down', note: 'Jefferies下调目标价至$340，营收首次预期下滑' },
        ],
        priority: 'inflection',
        tags: ['市场情绪', '趋势'],
      },
      {
        conclusion: '哈萨克斯坦石油基金分配$3.5亿投资加密资产，主权基金入场信号',
        impacts: [
          { asset: 'COIN', direction: 'up', note: 'Coinbase已推出股票交易+USDC持币奖励，机构化加速' },
          { asset: 'BTC/加密', direction: 'up', note: '主权基金配置加密=长期合法化信号' },
        ],
        priority: 'important',
        tags: ['加密', '机构'],
      },
    ...
    en: [
      {
        conclusion: 'US-Iran conflict escalates: Iran attacks US oil tanker near Kuwait, WTI crude tops $85/bbl',
        impacts: [
          { asset: 'XOM/CVX', direction: 'up', note: 'Oil surge benefits energy; Goldman sees $100 in 5 weeks' },
          { asset: 'COST/Consumer', direction: 'down', note: 'Higher oil raises transport costs, squeezes margins' },
        ],
        priority: 'urgent',
        tags: ['Geopolitics', 'Commodities'],
      },
      {
        conclusion: 'ECB 25bps rate hike fully priced in; Fed holds at 3.5-3.75%',
        impacts: [
          { asset: 'Growth stocks', direction: 'down', note: 'Global rate expectations rising, compressing valuations' },
          { asset: 'BRK-B', direction: 'up', note: 'Insurance float yield improves, NIM widens' },
        ],
        priority: 'important',
        tags: ['Central Bank', 'Rates'],
      },
      {
        conclusion: 'S&P 500 near record highs despite geopolitical turmoil, resilience surprises',
        impacts: [
          { asset: 'NVDA/META', direction: 'up', note: 'AI thesis intact, tech flows continue' },
          { asset: 'UNH', direction: 'down', note: 'Jefferies cuts PT to $340, first revenue decline in decades' },
        ],
        priority: 'inflection',
        tags: ['Sentiment', 'Trend'],
      },
      {
        conclusion: 'Kazakhstan sovereign fund allocates $350M to crypto assets',
        impacts: [
          { asset: 'COIN', direction: 'up', note: 'Coinbase expanding stock trading + USDC rewards, institutionalization accelerates' },
          { asset: 'BTC/Crypto', direction: 'up', note: 'Sovereign fund allocation = long-term legitimization signal' },
        ],
        priority: 'important',
        tags: ['Crypto', 'Institutional'],
      },
    ],
  };
}
